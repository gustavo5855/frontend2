                            ...
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    ...
                                    <div className="collapse" id="navbar-components">
                                        <ul className="nav nav-sm flex-column">
                                            ...
                                            <li className="nav-item">
                                                <a href="#navbar-multilevel" className="nav-link" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-multilevel">Multi
                                level</a>
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" href="../../pages/charts.html">
                                        <i className="ni ni-chart-pie-35 text-info" />
